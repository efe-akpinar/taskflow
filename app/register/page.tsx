...
import { ArrowRight, Kanban, LockKeyhole, Mail, UserPlus } from "lucide-react";
        ...
        >
          <div className="space-y-2">
            ...
            <p className="text-sm leading-6 text-zinc-600 dark:text-zinc-400">
              İlk boardunu oluşturmak için hesabını birkaç saniyede hazırla.
            </p>
          </div>
          ...
          <label className="block">
            <span className="text-sm font-medium">
              Parola <span className="text-zinc-500">(en az 6 karakter)</span>
            </span>
            <div className="relative mt-1">
